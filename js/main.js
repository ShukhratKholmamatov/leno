...
const langData = {
    uz: {
        ...
        "smm-story-1": "<li>• 0 tizimlashtirilgan muvaffaqiyatli kiyim brendi</li><li>• Professional brending yondashuvi</li><li>• 70+ uniforma — kompaniyalar va ta'lim muassasalari bilan hamkorlik</li>",
        "smm-story-2": "<li>• Brend tanilishi va PR strategiyasi</li><li>• Professional media va dizayn xizmatlari</li><li>• O'zbekiston bo'ylab distribyutor hamkorlar</li>",
        "smm-story-3": "<li>• Brend identifikatsiyasi va Piar tizimi</li><li>• SMM va marketing bo'yicha strukturaviy yondashuv</li><li>• Mijozlar bazasi va CRM tizimi</li>",
        "smm-story-4": "<li>• Barqaror va kuchli lead generatsiya tizimi</li><li>• Oyiga 10+ xizmatdan foydalanuvchi faol mijozlar</li><li>• Yuqori samarali marketing tizimi</li>",
        "smm-story-5": "<li>• Professional foto/media yondashuv</li><li>• Strategik yuritilgan ijtimoiy tarmoqlar tizimi</li><li>• Piar tizimi</li>",
    ...
    ru: {
        ...
        "smm-story-1": "<li>• Систематизированный успешный бренд одежды</li><li>• Профессиональный подход к брендингу</li><li>• 70+ униформ — сотрудничество с компаниями и учебными заведениями</li>",
        "smm-story-2": "<li>• Узнаваемость бренда и PR стратегия</li><li>• Профессиональные медиа и дизайн услуги</li><li>• Партнёры-дистрибьюторы по всему Узбекистану</li>",
        "smm-story-3": "<li>• Идентификация бренда и PR система</li><li>• Структурный подход к SMM и маркетингу</li><li>• Клиентская база и CRM система</li>",
        "smm-story-4": "<li>• Стабильная и мощная система лидогенерации</li><li>• 10+ активных клиентов ежемесячно</li><li>• Высокоэффективная маркетинговая система</li>",
        "smm-story-5": "<li>• Профессиональный фото/медиа подход</li><li>• Стратегически управляемые социальные сети</li><li>• PR система</li>",
        "badge-prestige": "БРЕНД УНИФОРМЫ", "badge-success": "70+ УНИФОРМ",
        "tag-furniture": "Мебельная Компания", "tag-branding": "CRM Система",
        "tag-education": "Образование", "tag-students": "10+ Клиентов/мес",
        "tag-school": "Школа", "tag-media": "Медиа + PR",
    ...
    en: {
        ...
        "smm-story-1": "<li>• Systematized successful clothing brand</li><li>• Professional branding approach</li><li>• 70+ uniforms — partnerships with companies and schools</li>",
        "smm-story-2": "<li>• Brand recognition and PR strategy</li><li>• Professional media and design services</li><li>• Distributor partners across Uzbekistan</li>",
        "smm-story-3": "<li>• Brand identity and PR system</li><li>• Structured SMM and marketing approach</li><li>• Client base and CRM system</li>",
        "smm-story-4": "<li>• Strong and stable lead generation system</li><li>• 10+ active clients monthly</li><li>• High-performance marketing system</li>",
        "smm-story-5": "<li>• Professional photo/media approach</li><li>• Strategically managed social media</li><li>• PR system</li>",
